...
class Bot(Client):
    ...
    async def start(self):
        ...
        logging.info(LOG_MSG.format(me.first_name, date, tame))
        
        try: await self.send_message(LOG_CHANNEL, text=LOG_MSG.format(me.first_name, date, tame), disable_web_page_preview=True)   
